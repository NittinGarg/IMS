...
public class View_Retailer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Retailer frame = new View_Retailer();
	 ...
	 */
	public View_Retailer() throws FileNotFoundException {
...
//				}
		...
		lblViewRetailer.setFont(new Font("Tahoma", Font.BOLD, 18));
	...
	private String txtEnterBetween_getText() {
		// TODO Auto-generated method stub
		return null;
	}
}
